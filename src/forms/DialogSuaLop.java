...
public class DialogSuaLop extends JDialog{
    JComboBox<Object> cboMalop;
    JTextField txtTenlop;
    JTextField txtKhoa;
    JTextField txtSiso;
    JComboBox<Object> cboMaGV;
    public DialogSuaLop(Frame owner) {
        super(owner, "Sửa lớp", ModalityType.DOCUMENT_MODAL);
    ...
    private void SuaLop(String Malop, String Tenlop, String Khoa, String Siso, String MaGV) {
