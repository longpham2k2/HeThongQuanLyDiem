 ...
 * @author Admin
 */
public class FormQuanLyLop extends JFrame{
    ...
    private void addControl() {
        ...
        JLabel lblTitle = new JLabel("Danh sách lớp");
        ...
        btnCreate.addActionListener((ActionEvent e) -> {
            JDialog dialog = new DialogThemLop(this);
            dialog.setVisible(true);
            tb.setModel(DanhSach());
            this.repaint();
        });
        btnUpdate.addActionListener((ActionEvent e) -> {
            JDialog dialog = new DialogSuaLop(this);
            dialog.setVisible(true);
            tb.setModel(DanhSach());
            this.repaint();
        });
        btnDelete.addActionListener((ActionEvent e) -> {
            JDialog dialog = new DialogXoaLop(this);
            dialog.setVisible(true);
            tb.setModel(DanhSach());
            this.repaint();
        });
    ...
    public DefaultTableModel DanhSach() {
        String[] attributes = new String[]{"Malop", "Tenlop", "Khoa", "Siso", "MaGV"};
