 ...
 * @author Admin
 */
public class FormQuanLyHocSinh extends JFrame{
    ...
    private void addControl() {
        ...
        JLabel lblTitle = new JLabel("Danh sách học sinh");
    ...
    public DefaultTableModel DanhSach() {
        String[] attributes = new String[]{"Mahs", "Malop", "Hoten", "Ngaysinh", "Email", "Password"};
