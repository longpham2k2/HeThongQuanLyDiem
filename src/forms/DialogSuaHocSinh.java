...
public class DialogSuaHocSinh extends JDialog{

    public DialogSuaHocSinh(Frame owner) {
    ...
    private void SuaHocSinh(String Mahs, String Malop, String Hoten, String Ngaysinh, String Email, String Password) {
