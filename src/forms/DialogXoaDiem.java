...
public class DialogXoaDiem extends JDialog{
    JComboBox<Object> cboMahs; 
    JComboBox<Object> cboMaloptheomon; 
    JTextField txtDiem;
    public DialogXoaDiem(Frame owner) {
        super(owner, "Xóa điểm", ModalityType.DOCUMENT_MODAL);
    ...
    private void XoaDiem(String Mahs, String Maloptheomon) {
        List<Object> data = new ArrayList<Object>();
        data.add(Mahs);
        data.add(Maloptheomon);
        
        String title = "XoaDiem";
